  ...
  const menuItems = [
    {
      ...
      dropdown: [
        ...
        { title: "SEO Optimization", href: "/services/seo-optimization" },
      ],
    },
    // {
    //   title: "Portfolio",
    ...
    { title: "Client Portal", href: "/client-portal", icon: "🔒" },
  ];
          ...
          >
            <div className="flex flex-col items-start justify-center h-full p-8">
              ...
              <div className="flex items-center gap-6">
                ...
                <Button variant="secondary" className="mt-6 text-lg" size="lg">
                  Register
                </Button>
              </div>
            </div>
